...
export default function Chat({ beverageName }: { beverageName: string }) {
  const fruits = [
    {
      id: 1,
      name: "Apple",
  ...
  const handleSendMessage = async () => {
    ...
    sendMessage({
      text: `Please generate a ${beverageName} recipe using ${selectedFruits.join(", ")}.`,
    });
  };
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-5 justify-center gap-8 mb-12 mt-20">
        {fruits.map((fruit) => (
          <div
            key={fruit.id}
  ...
  `}
      ...
      <h2 className="mt-10 text-center font-semibold">
        Let's choose your fruits for {beverageName}.
      </h2>
      ...
      <div className="flex items-center justify-center gap-6 mt-4">
        <div className="w-200">
          ...
          <div ref={chatContainerRef} className="mb-20"></div>
        </div>
      </div>
    </>
  );
