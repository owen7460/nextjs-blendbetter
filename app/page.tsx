    ...
    <>
      ...
      >
        ...
        <div className="absolute z-100 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-8">
          <h1 className="textFirst text-white text-8xl font-bold">
            Blendbetter
          </h1>
          ...
          <div className="flex items-center justify-center gap-8">
            <span className="buttonFirst text-white bg-transparent border border-white px-6 py-2 rounded-full text-lg font-bold">
              Learn More
            </span>
            <Link
              href="/dashboard"
